...
public interface Codes {
	...
	public static final int CODE_EXCEEDED_MAX_EXCEL_SIZE = 109;
	public static final int CODE_MISSING_FILE_UPLOAD = 110;
	public static final int CODE_PHASING_NOT_FOUND = 111;
}
